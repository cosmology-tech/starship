...
Starship is a unified development enrivonment that allow Cosmos developers to spin up a fully simulated mini-cosmos ecosystem
...
⚡️ [How to use Starship](https://thestarship.io/get-started)
...
### [chain-upgrade](https://github.com/cosmology-tech/starship/tree/main/examples/upgrade-test)
