...
func file_exposer_mnemonic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_exposer_mnemonic_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_exposer_mnemonic_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Keys); i {
			case 0:
				return &v.state
			case 1:
		...
		file_exposer_mnemonic_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_exposer_mnemonic_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_exposer_mnemonic_proto_msgTypes[4].Exporter = func(v any, i int) any {
