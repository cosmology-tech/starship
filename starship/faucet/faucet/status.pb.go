...
func file_faucet_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_faucet_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Coin); i {
			case 0:
				return &v.state
			case 1:
		...
		file_faucet_status_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_faucet_status_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*State); i {
			case 0:
				return &v.state
			case 1:
