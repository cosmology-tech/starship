...
require (
	github.com/cosmology-tech/starship/clients/go/client v0.0.0-20230411094226-129001b2f52a
...
replace (
	github.com/cosmology-tech/starship/clients/go/client => ../clients/go/client
